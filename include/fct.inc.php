...
/**
 * Permet l'ajout dans une variable de session des informations
 * concernant le Visiteur sur lequel le comptable travaille
 * @param type $leMois
 * @param type $leVisiteur
 */
function memoriseLeVisiteur($leMois, $leVisiteur) {
